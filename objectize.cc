...
EMSCRIPTEN_KEEPALIVE void overlapBoxPhysics(PScene *scene, float hx, float hy, float hz, float *position, float *quaternion, float *meshPosition, float *meshQuaternion, unsigned int *hit, unsigned int *id, unsigned int *filters, unsigned int numFilters) {
  scene->overlapBox(hx, hy, hz, position, quaternion, meshPosition, meshQuaternion, *hit, *id, filters, numFilters);
}
EMSCRIPTEN_KEEPALIVE void overlapCapsulePhysics(PScene *scene, float radius, float halfHeight, float *position, float *quaternion, float *meshPosition, float *meshQuaternion, unsigned int *hit, unsigned int *id, unsigned int *filters, unsigned int numFilters) {
  scene->overlapCapsule(radius, halfHeight, position, quaternion, meshPosition, meshQuaternion, *hit, *id, filters, numFilters);
}
